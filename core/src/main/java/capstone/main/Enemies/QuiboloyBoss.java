...
public class QuiboloyBoss extends AbstractEnemy {
    ...
    public QuiboloyBoss(float x, float y, ScreenShake screenShake, PhysicsManager physics) {

        super(x, y,
            new Texture("Textures/Enemies/World3/Quiboloy/Run-Forward/quiboloy_walk-0.png"),
            3.0f, 3.0f, 200, screenShake, physics); // Boss HP higher
