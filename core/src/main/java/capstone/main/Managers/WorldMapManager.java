...
public class WorldMapManager {
    ...
    static {
        ...
        SPAWN_POINTS.put(WorldMap.WORLD_2_BOSS, new SpawnPoint(32f, 32f, "Center area"));
        
        // World 3 - Bottom left spawn
        SPAWN_POINTS.put(WorldMap.WORLD_3, new SpawnPoint(16f, 48f, "Bottom entrance"));
        
        // World 3 Boss - Center spawn
        SPAWN_POINTS.put(WorldMap.WORLD_3_BOSS, new SpawnPoint(32f, 32f, "Boss arena center"));
    }
    ...
    static {
        ENEMY_COUNTS.put(WorldMap.WORLD_1, 10);
        ENEMY_COUNTS.put(WorldMap.WORLD_1_BOSS, 3);
        ENEMY_COUNTS.put(WorldMap.WORLD_2, 12);
        ENEMY_COUNTS.put(WorldMap.WORLD_2_BOSS, 5);
        ENEMY_COUNTS.put(WorldMap.WORLD_3, 15);
        ENEMY_COUNTS.put(WorldMap.WORLD_3_BOSS, 1); // Single boss
    }
